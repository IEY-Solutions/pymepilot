...
\`\`\`bash  
\# Crear el archivo  
mkdir \-p /home/pato/pymepilot-core/.claude/skills/security  
nano /home/pato/pymepilot-core/.claude/skills/security/security-audit-checklist.md

\# Pegar el contenido de arriba

\# Testear con Claude Code  
