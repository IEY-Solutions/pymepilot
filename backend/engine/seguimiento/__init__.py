...
# Para agregar una nueva vertical al modulo seguimiento:
#   1. Crear la clase en backend/engine/seguimiento/
#   2. Registrarla aca
#   3. Agregarla al active_verticals del tenant en la DB
VERTICAL_REGISTRY: dict[str, str] = {
    'reposicion': 'backend.engine.seguimiento.reposicion.VerticalReposicion',
    'activacion': 'backend.engine.seguimiento.activacion.VerticalActivacion',
    'recuperacion': 'backend.engine.seguimiento.recuperacion.VerticalRecuperacion',
    'cross_sell': 'backend.engine.seguimiento.cross_sell.VerticalCrossSell',
}
